...
<svelte:head>
  <title>omysoul.io</title>
</svelte:head>

<h1>omysoul</h1>

<p>
  Thanks for visiting. We are trying to gather a large number of people to
  worship in public spaces around the world. We are looking for the first
  pioneers willing to step out. If you think this might be you please sign up
  for the newsletter.
</p>
