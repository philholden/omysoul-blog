...
<svelte:head>
  <title>What technology for worship and preaching on the street?</title>
</svelte:head>
<h1>What technology for worship and preaching on the street?</h1>

<img style="margin: 8px 0;width: 100%" src="/img/omysoul-tech-plain.svg" />

<p>
  Would you like a wireless, battery powered, set up for lyrics and
  presentations that you can take out onto the streets? I will describe a
  solution that:
</p>
<ul>
  <li>can be set up in three minutes</li>
  <li>fits in a small backpack</li>
  <li>uses cheap off-the-shelf hardware and free software</li>
</ul>
<div class="videoWrapper">
  <iframe
    ...
    width="560"
    height="315"
    src="https://www.youtube.com/embed/PpsdrnFf9nU"
    frameborder="0"
...
<p>
  In this set up most devices are set to be viewer devices (phones, TVs and
  projectors). They will all display the same lyrics or slides at the same time.
</p>
...
<p>
  For a slide show the presenter phone also shows speaker notes between the
  slides. The preacher can control which slide is displayed next and also be
  reminded of what they intend to say.
</p>

<img
  style="max-width: 100%; width: 280px;display: block; margin: 24px auto"
  src="/img/phone-controller.jpg" />

<p>
  A very simple set up will consist only of phones connected to their normal
  mobile network (4G, 5G etc). One presenter phone controls what all the other
  phones see.
</p>
...
<h2>Projectors</h2>
<img
  style="margin: 24px 0;max-width: 100%;display: block;"
...
<img
  style="max-width: 100%; width: 480px;display: block; margin: 48px auto"
...
<div style="display: flex; flex-wrap: wrap; margin: 32px 0;">
  <img
...
<p>
  Android projectors also have their own memory this means you can download
  videos on them and can then pair the speakers to the projector. This allows
  you to have video with sound on the street. You can use this for testimonies
  and gospel presentations.
</p>

<h2>Sound recorder</h2>
<p>
  The last piece of kit which is very handy is a sound recorder. This can be
  used to:
</p>
<ul>
  <li>
    pre-record audio for a presentation that will be played via a Bluetooth
    speaker on the street
  </li>
  <li>
    pre-record vocals and music and send to your group beforehand so they can
...
<p>
  If we can get great musicians out on the street, video the worship and upload
  to social media we create a positive feedback loop that will help gather more
  people out onto the street to worship. This video shows how a good musicians
  and a good sound recorder can make a compelling worship video on Youtube.
</p>
...
<div class="videoWrapper">
  <iframe
    ...
    width="560"
    height="315"
    src="https://www.youtube.com/embed/5ilaah976sw"
    frameborder="0"
    allow="accelerometer; autoplay; encrypted-media; gyroscope;
    picture-in-picture"
    allowfullscreen />
...
<div class="videoWrapper">
  <iframe
    ...
    width="560"
    height="315"
    src="https://www.youtube.com/embed/xa1saiWejjo"
    frameborder="0"
    allow="accelerometer; autoplay; encrypted-media; gyroscope;
    picture-in-picture"
    allowfullscreen />
